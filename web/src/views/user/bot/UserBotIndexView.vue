...
export default {
    ...
    setup(){
        ...
        const refresh_bots = () =>{
            $.ajax({
                url: "https://xiaxinyuxy.top/api/user/bot/getlist",
                type: "get",
                headers:{
        ...
        const add_bot = () => {
            ...
            $.ajax({
                url:"https://xiaxinyuxy.top/api/user/bot/add",
                type: "post",
                data:{
                    title:botadd.title,
        ...
        const remove_bot = (bot) => {
            $.ajax({
                url:"https://xiaxinyuxy.top/api/user/bot/remove",
                type: "post",
                data:{
                    bot_id:bot.id,
                },
        ...
        const update_bot = (bot) => {
            bot.error_message = "",
            $.ajax({
                url:"https://xiaxinyuxy.top/api/user/bot/update",
                type: "post",
                data:{
                    bot_id:bot.id,
                    title:bot.title,
