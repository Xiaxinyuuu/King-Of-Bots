...
import com.xiaxinyu.kob.backend.service.user.account.acwing.AcAppService;
...
public class AcAppServiceImpl implements AcAppService {
    ...
    private final static String appId = "3649";
    private final static String appSecret = "98187109e3d14374b634489ddc28505f";
    private final static String redirectUri = "https://app3649.acapp.acwing.com.cn/api/user/account/acwing/acapp/receive_code";
