package com.xiaxinyu.kob.backend.consumer;

import com.alibaba.fastjson.JSONObject;
import com.xiaxinyu.kob.backend.consumer.utils.Game;
import com.xiaxinyu.kob.backend.consumer.utils.JwtAuthentication;
...
public class WebSocketServer {
    ...
    private void move(int direction){
        if(game.getPlayerA().getId().equals(user.getId())){
            ...
            System.out.println(game.getPlayerA().getBotId());
            System.out.println(game.getPlayerA().getBotId());
