...
import com.xiaxinyu.kob.backend.service.user.bot.UpdateService;
...
public class UpdateServiceImpl implements UpdateService {
    ...
    public Map<String, String> update(Map<String, String> data) {
        ...
        if(!bot.getUserId().equals(user.getId())){
            res.put("error_message","没有权限修改该Bot");
            return res;
        }
        Bot new_bot = new Bot(bot.getId(),user.getId(),title,description,content,bot.getRating(),bot.getCreatetime(),
        new Date());
